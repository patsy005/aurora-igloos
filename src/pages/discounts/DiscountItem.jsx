	...
	return (
		<>
			<section className="item-section section mt-5">
				...
				<p className="mt-4"></p>
				<SectionHeading sectionTitle={getContentFromMap(contentMap, 'discountsItem.heading', 'Promotion')}></SectionHeading>
				...
				<div className="item-section__overview section-box section-margin flex-md-row promo-item">
					<div className="item-section__info col-12 ">
						...
						<div className="item-section__promo">
							<p className="promo uppercase-text">{getContentFromMap(contentMap, 'form.common.label', 'Description')}</p>
						...
						<div className="item-section__boxes flex-lg-row gap-lg-5 justify-content-lg-between col-12">
							<ItemDetailsCard title={getContentFromMap(contentMap, 'common.discount', 'Discount')} number={promotion.discount} />
						</div>

						<div className="item-section__promo mt-3">
							<p className="promo uppercase-text">{getContentFromMap(contentMap, 'igloos.heading', 'Igloos')}</p>
						...
						<div className="item-section__availability">
							<p className="uppercase-text mb-4 mt-3">{getContentFromMap(contentMap, 'iglooItem.availability', 'Availability')}</p>
