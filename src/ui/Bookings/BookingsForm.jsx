...
function BookingsForm({}) {
	...
	const [startDate, setStartDate] = useState(bookingId ? bookings.find(booking => booking.id === +bookingId).checkInDate : new Date())
	const [endDate, setEndDate] = useState(bookingId ? bookings.find(booking => booking.id === +bookingId).checkOutDate : null)
